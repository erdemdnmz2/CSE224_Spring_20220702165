module TopZeroToFive (btnC,
 ...
 sky130_fd_sc_hd__o21ai_1 _080_ (.A1(\u_cnt.count[0] ),
    ...
    .B1(_047_),
    .Y(net6));
 sky130_fd_sc_hd__inv_2 _081_ (.A(\div_cntr[0] ),
    .Y(_004_));
 ...
 sky130_fd_sc_hd__inv_2 _131_ (.A(net1),
    .Y(_027_));
 sky130_fd_sc_hd__dfxtp_2 _132_ (.CLK(clk),
    .D(_004_),
    .Q(\div_cntr[0] ));
 ...
 sky130_fd_sc_hd__dfxtp_1 _136_ (.CLK(clk),
    .D(_018_),
    .Q(\div_cntr[4] ));
 sky130_fd_sc_hd__dfxtp_1 _137_ (.CLK(clk),
    .D(_019_),
    .Q(\div_cntr[5] ));
 sky130_fd_sc_hd__dfxtp_1 _138_ (.CLK(clk),
    .D(_020_),
    .Q(\div_cntr[6] ));
 sky130_fd_sc_hd__dfxtp_1 _139_ (.CLK(clk),
    .D(_021_),
    .Q(\div_cntr[7] ));
 sky130_fd_sc_hd__dfxtp_1 _140_ (.CLK(clk),
    .D(_022_),
    .Q(\div_cntr[8] ));
 sky130_fd_sc_hd__dfxtp_1 _141_ (.CLK(clk),
    .D(_023_),
    .Q(\div_cntr[9] ));
 sky130_fd_sc_hd__dfxtp_1 _142_ (.CLK(clk),
    .D(_005_),
    .Q(\div_cntr[10] ));
 sky130_fd_sc_hd__dfxtp_1 _143_ (.CLK(clk),
    .D(_006_),
    .Q(\div_cntr[11] ));
 sky130_fd_sc_hd__dfxtp_1 _144_ (.CLK(clk),
    .D(_007_),
    .Q(\div_cntr[12] ));
 sky130_fd_sc_hd__dfxtp_1 _145_ (.CLK(clk),
    .D(_008_),
    .Q(\div_cntr[13] ));
 sky130_fd_sc_hd__dfxtp_1 _146_ (.CLK(clk),
    .D(_009_),
    .Q(\div_cntr[14] ));
